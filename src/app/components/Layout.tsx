        ...
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-[2px] min-w-0">
              ...
              <p className="font-['Roboto',sans-serif] text-[8px] text-muted-foreground whitespace-nowrap leading-normal mt-[3px]">
        ...
        <nav className="flex-1 p-2 overflow-y-auto">
          {navItems.map((item) => (
            ...
            >
              ...
              {item.path === "/replacements" && pendingReplacements > 0 && (
