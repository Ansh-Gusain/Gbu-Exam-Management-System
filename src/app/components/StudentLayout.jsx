...
const navItems = [
  ...
  { path: "/student/exams", label: "Exam Schedule", icon: FileText },
  { path: "/student/seating", label: "My Seat", icon: Grid3X3 },
  { path: "/student/attendance", label: "Attendance", icon: ClipboardList }
];
function StudentLayout() {
  const { students, loggedInStudentId, setLoggedInStudentId, setCurrentRole } = useStore();
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "p-4 border-b border-border", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-[2px] min-w-0", children: [
              ...
              /* @__PURE__ */ jsx(Badge, { className: "mt-1 text-[0.6rem] bg-blue-100 text-blue-700 w-fit", children: "Student Portal" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("nav", { className: "flex-1 p-2 overflow-y-auto", children: navItems.map((item) => /* @__PURE__ */ jsxs(
            NavLink,
            {
              to: item.path,
              onClick: () => setSidebarOpen(false),
              className: ({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg text-[0.8rem] mb-0.5 transition-colors ${isActive ? "bg-blue-600 text-white" : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"}`,
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-3 border-t border-border space-y-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "px-3 py-1.5", children: [
              /* @__PURE__ */ jsx("p", { className: "text-[0.75rem] font-medium truncate", children: currentStudent?.name || "Student" }),
              /* @__PURE__ */ jsxs("p", { className: "text-[0.65rem] text-muted-foreground truncate", children: [
