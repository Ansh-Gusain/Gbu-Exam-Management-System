...
import {
  LayoutDashboard, FileText, Grid3X3, ClipboardList, Menu,
  LogOut
} from "lucide-react";
        ...
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-[2px] min-w-0">
              ...
              <Badge className="mt-1 text-[0.6rem] bg-blue-100 text-blue-700 w-fit">
                Student Portal
              </Badge>
            </div>
          </div>
        ...
        <div className="p-3 border-t border-border space-y-2">
          <div className="px-3 py-1.5">
            ...
            <p className="text-[0.65rem] text-muted-foreground truncate">
              {currentStudent?.rollNumber || "—"} &bull; {currentStudent?.branch} &bull; Sem {currentStudent?.semester}
            </p>
          </div>
          <button
